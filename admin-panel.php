...
<html>
 ...
 <div class="jumbotron" style="border-radius:0;background:url('images/cricket1.jpg');background-size:cover;height:900px;></div>
				        ...
				        if (isset($_SESSION['u_id'])) {
						  echo '<form action="includes/index.php" method="POST">
							...
							echo '<form action="includes/index.php" method="POST">
				              ...
				              <a href="welcome.php" class="btn btn-light" style="background-color:#3498DB;color:FFFFFF">Logout</a>';
